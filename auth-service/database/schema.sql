...
-- Complete user management system for the medical store
...
CREATE TABLE password_history (
    ...
    CONSTRAINT recent_passwords_only EXCLUDE (user_id WITH =) WHERE (changed_at > NOW() - INTERVAL '1 year')
);
...
VALUES (
    ...
    '$2b$10$rEuVt2qKJbGq2YkKJbGq2YKJbgq2YKJbgq2YKJbgq2YKJbgq2YKJ', -- Manager123!
    'manager',
    'active',
    true
) ON CONFLICT (email) DO NOTHING;
